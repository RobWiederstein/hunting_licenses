...
```{r plot-law-library-collection, fig.cap="Plot shows that the vast majority of federal legislation occurred in the twenty years between 1900 and 1920.", fig.align="center", out.width="65%", warning=FALSE, message=FALSE}
...
```{r library-of-congress-conservation-bib, warning=FALSE, message=FALSE, include=FALSE}
...
#                header = T,
#                stringsAsFactors = F)
# df.01 <- dplyr::select(df, date, cite_1, type, summary_1)
# #DT::datatable(iris)
# #DT:::DT2BSClass('display')
# DT::datatable(df.01, escape = FALSE, style = 'bootstrap', class = "table table-striped", rownames = FALSE)
