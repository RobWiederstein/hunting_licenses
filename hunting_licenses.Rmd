...
programs.[@congressionalresearchservicePittmanRobertsonWildlifeRestoration2019]

```{r usfw-wildlife-receipts, fig.align="center", out.width="65%", fig.cap="Gross Receipts Wildlife Restoration by Type.  Source:  [USFW](https://www.fws.gov/wsfrprograms/Subpages/GrantPrograms/WR/WR_ExciseTax.html)" }
...
plot_receipts_and_deductions_usfw_wl_rest()
```

The Pittman-Robertson act directed that funds collected from the sale of firearms be deposited into the Federal Aid to Wildlife Restoration Fund. 
-  a 10 percent tax on pistols and revolvers[@26USCS4181];
-  an 11 percent tax on bows, archery equipment,and long arms[@26USCS4181]; and
-  an inflation adjusted tax on arrow shafts, standing at 48 cents per shaft in 2014[@26USCS4161].
...
[@congressionalresearchservicePittmanRobertsonWildlifeRestoration2019] The funds directed toward wildlife restoration are apportioned according to forumula.  One-half of the apportionment is based on the ratio of the state's land mass relative to the land mass of the whole country.  The second half of the forumula apportions the funds based upon the number of state hunting license holders to the total number of hunting license holders. No state receives more than 5% of the apportionment or less than one-half of 1% of the apportionment.

```{r sankey_pr_funds, fig.align="center", fig.cap="Figure shows the flow of tax revenue into the wildlife restoraton fund and the flows out to the different states.", message=F, warning=F}
