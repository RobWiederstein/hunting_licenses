...
```{r plot-law-library-collection, fig.cap="Plot shows that the vast majority of federal legislation occurred in the twenty years between 1900 and 1920.", fig.align="center", warning=FALSE, message=FALSE}
...
```{r library-of-congress-conservation-bib, warning=FALSE, message=FALSE}
